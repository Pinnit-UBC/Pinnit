...
import EventsList from "./pages/event_display/EventsList"; // Import custom component for listing events
...
import AddEvent from "./pages/add_events/AddEvent"; // Import component for adding an event
import MobileTimeline from "./components/mobile/MobileTimeline"; // Import component for mobile view timeline
import MobileFilterButton from "./components/mobile/MobileFilterButton"; // Import mobile filter button component
import MobileDatePickerButton from "./components/mobile/MobileDatePickerButton"; // Import mobile date picker button component
import MobileEventsList from "./components/mobile/MobileEventsList"; // Import component to display event list on mobile
import MenuDrawer from "./components/ui/menu_drawer/MenuDrawer"; // Import sidebar drawer for navigation
import EventDrawer from "./pages/event_display/EventDrawer"; // Import component to display event details in a drawer
import SubscriptionForm from "./components/SubscriptionForm"; // Import component for subscription form
import GoogleMapsScriptLoader from "./hooks/GoogleMapsScriptLoader"; // Import component to load Google Maps script
import MessageScreen from "./components/MessageScreen"; // Import component for displaying messages or alerts
import ClubsAndOrganizations from "./pages/clubs/ClubsAndOrganizations"; // Import component for listing clubs and organizations
import FeedbackForm from "./pages/feedback/FeedbackForm"; // Import feedback form component
  ...
  return (
    <GoogleMapsScriptLoader apiKey={process.env.REACT_APP_GOOGLE_MAPS_API_KEY}>
      <div className="App">
        ...
        {!isAddEventPage &&
          !isClubsOrganizationsPage &&
          !isFeedbackPage && ( // Show main content if not on specific pages
