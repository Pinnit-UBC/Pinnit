      ...
      {isMobile ? (
        ...
        <div className="timeline-container">
          <div className="timeline-dot-container">
            <div
              className={`timeline-text previous-day ${
                selectedDayOfWeek === yesterday ? "selected" : ""
              }`}
            >
              {yesterday}
            </div>
            <div
              className="timeline-dot hollow clickable"
          ...
          <div
            className={`timeline-dot hollow clickable ${
              selectedDayOfWeek === todayDayOfWeek ? "selected" : ""
            }`}
            style={{ marginLeft: "33%" }}
          ></div>
          <div
            className={`timeline-text ${
              selectedDate === todayDate ? "today" : "middle-day"
            }`}
            style={{ left: "34%" }}
          >
          ...
          <div
            className={`timeline-dot hollow clickable ${
              selectedDayOfWeek === tomorrow ? "selected" : ""
            }`}
            style={{ marginLeft: "48%" }}
            onClick={handleTomorrowClick}
          ></div>
          <div
            className={`timeline-text tomorrow ${
              selectedDayOfWeek === tomorrow ? "selected" : ""
            }`}
            style={{ left: "83%" }}
          >
            <span
              className={`timeline-tomorrow-day ${
                selectedDayOfWeek === tomorrow ? "selected" : ""
              }`}
            >
              {tomorrow}
