...
function ClubsAndOrganizations() {
  ...
  useEffect(() => {
    const fetchXLSX = async () => {
      try {
        ...
        const uniqueFacultiesSheet2 = Array.from(
          new Set(sheet2.map((club) => club["Faculty"]))
        );
  ...
  const handleCategoryClick = (category) => {
    ...
    if (category === "all") {
      setFilteredData(
        sheet1Data.sort((a, b) => b["# of followers"] - a["# of followers"])
      );
    } else {
  ...
  const handleFacultyClick = (faculty) => {
    ...
    if (faculty === "all") {
      setFilteredData(
        sheet2Data.sort((a, b) => b["# of followers"] - a["# of followers"])
      );
    } else {
        ...
        <>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            >
              ...
              <div
                onClick={() => handleFacultyClick("all")}
                style={{ textAlign: "center", cursor: "pointer" }}
              >
                <img
